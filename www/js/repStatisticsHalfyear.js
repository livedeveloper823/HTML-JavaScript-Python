...
{
	$ ('#p-error').hide ();
	var half = parseInt ($ ('#sel-half').val ().trim (), 10);
	...
	window.open ('../reports/statisticsHalfyear.html?y=' + year + '&h=' + half);
}
...
function onPDF ()
{
	...
	var jqXHR = $.ajax ( {
		...
		type: 'POST',
		data: JSON.stringify ( {'f': 'repGenStatisticsHalfyearPDF', 'p': params} ),
